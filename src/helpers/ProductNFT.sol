...
contract ProductNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function safeMint(address to, string memory uri) public onlyOwner onlyMarketplace returns (uint256) {
    ...
    function transfer(address from, address to, uint256 tokenId) public onlyMarketplace {
